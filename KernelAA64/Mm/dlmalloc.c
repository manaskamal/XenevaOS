...
/*
    ...
    */
DLMALLOC_EXPORT void**
mspace_independent_calloc(mspace msp, size_t n_elements, size_t elem_size, void* chunks[]);
...
/*
    ...
    */
DLMALLOC_EXPORT void**
mspace_independent_comalloc(mspace msp, size_t n_elements, size_t sizes[], void* chunks[]);
...
#if defined(USE_RECURSIVE_LOCKS) && USE_RECURSIVE_LOCKS != 0 && defined(linux) &&                  \
...
static size_t release_unused_segments(mstate m) {
	...
	/* Reset check counter */
	m->release_checks =
		(((size_t)nsegs > (size_t)MAX_RELEASE_CHECK_RATE) ? (size_t)nsegs
			...
			if ((((size_t)(mem)) & (alignment - 1)) != 0) { /* misaligned */
              ...
              */
				char* br = (char*)mem2chunk(
					(size_t)(((size_t)((char*)mem + alignment - SIZE_T_ONE)) & -alignment));
...
void dlmalloc_inspect_all(
	void (*handler)(void* start, void* end, size_t used_bytes, void* callback_arg), void* arg) {
	ensure_initialization();
	if (!PREACTION(gm)) {
