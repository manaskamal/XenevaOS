 ...
 */
#if ((defined (_WIN32) && !defined (_WIN32_WCE)) || (defined (__WINS__) && defined (_SYMBIAN)) || (defined (WINCE_EMULATOR)) || (defined (_OPENWAVE_SIMULATOR))) && !defined(__aarch64__)
...
#elif defined(ARDUINO) || defined(ESP32) || defined(ESP_PLATFORM) || defined(__aarch64__) || defined(__GNUC__) && (defined(__powerpc__) || defined(__POWERPC__)) || (defined (_SOLARIS) && !defined (__GNUC__) && !defined (_SOLARISX86))
