...
void doomgeneric_Tick()
{
    ...
    DG_StatEnd(DG_STAT_TICK);

    // Auto-report stats roughly every 30s of ticks (cumulative counters;
    // diff consecutive reports for per-window means). No key needed.
    {
