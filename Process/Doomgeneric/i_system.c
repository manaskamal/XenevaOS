...
void I_Quit (void)
{
    ...
    // Close the window first so no ghost lingers if an exit func
    // hangs (or exits directly, like D_Endoom does).
...
void I_Error (char *error, ...)
{
    ...
    // Tear down the window first so error exits don't leave ghosts.
