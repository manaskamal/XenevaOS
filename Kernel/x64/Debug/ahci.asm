...
; 174  : 			}
	...
	jmp	SHORT $LN14@AuAHCIInit
$LN13@AuAHCIInit:

; 175  : 			else if (dt == AHCI_DEV_PM) {

	cmp	DWORD PTR dt$1[rbp], 3
	jne	SHORT $LN15@AuAHCIInit
