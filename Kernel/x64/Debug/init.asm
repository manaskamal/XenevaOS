...
PUBLIC	??_C@_0BH@EIHIPOGA@Boot?5freeing?5kernel?5?$AN?6@ ; `string'
...
pdata	ENDS
;	COMDAT ??_C@_0BH@EIHIPOGA@Boot?5freeing?5kernel?5?$AN?6@
CONST	SEGMENT
??_C@_0BH@EIHIPOGA@Boot?5freeing?5kernel?5?$AN?6@ DB 'Boot freeing kernel'
...
; 130  : 	SeTextOut("Boot freeing kernel \r\n");

	lea	rcx, OFFSET FLAT:??_C@_0BH@EIHIPOGA@Boot?5freeing?5kernel?5?$AN?6@
	call	SeTextOut
