...
CONST	SEGMENT
$SG8622	DB	'Freeing up ', 0aH, 00H
	ORG $+3
$SG8733	DB	'ACPI interrupt handler called', 0aH, 00H
	ORG $+1
$SG8782	DB	'read mem', 0aH, 00H
	ORG $+6
$SG8803	DB	'Write mem', 0aH, 00H
	ORG $+5
$SG8824	DB	'read port', 0aH, 00H
	ORG $+5
$SG8838	DB	'Write port', 0aH, 00H
CONST	ENDS
