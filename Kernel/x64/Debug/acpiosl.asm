...
CONST	SEGMENT
$SG8587	DB	'Freeing up ', 0aH, 00H
	ORG $+3
$SG8698	DB	'ACPI interrupt handler called', 0aH, 00H
	ORG $+1
$SG8747	DB	'read mem', 0aH, 00H
	ORG $+6
$SG8768	DB	'Write mem', 0aH, 00H
	ORG $+5
$SG8789	DB	'read port', 0aH, 00H
	ORG $+5
$SG8803	DB	'Write port', 0aH, 00H
CONST	ENDS
