...
CONST	SEGMENT
$SG8584	DB	'Freeing up ', 0aH, 00H
	ORG $+3
$SG8695	DB	'ACPI interrupt handler called', 0aH, 00H
	ORG $+1
$SG8744	DB	'read mem', 0aH, 00H
	ORG $+6
$SG8765	DB	'Write mem', 0aH, 00H
	ORG $+5
$SG8786	DB	'read port', 0aH, 00H
	ORG $+5
$SG8800	DB	'Write port', 0aH, 00H
CONST	ENDS
