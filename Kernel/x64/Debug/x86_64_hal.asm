...
msvcjmc	SEGMENT
__520710F6_x86_64_hal@cpp DB 01H
msvcjmc	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?x86_64_hal_initialise@@YAXPEAU_KERNEL_BOOT_INFO_@@@Z DD 025030f01H
	DD	0d20a230fH
	DD	05006H
xdata	ENDS
...
;	COMDAT ?x86_64_hal_initialise@@YAXPEAU_KERNEL_BOOT_INFO_@@@Z
_TEXT	SEGMENT
cpu$ = 0
info$ = 96
?x86_64_hal_initialise@@YAXPEAU_KERNEL_BOOT_INFO_@@@Z PROC ; x86_64_hal_initialise, COMDAT
...
$LN3:
	...
	lea	rcx, OFFSET FLAT:__520710F6_x86_64_hal@cpp
...
; 60   : 	
; 61   :    
; 62   : 	AuACPIInitialise(info->acpi_table_pointer);
...
; 63   : 
; 64   : 	x86_64_initialise_syscall();

	call	?x86_64_initialise_syscall@@YAXXZ	; x86_64_initialise_syscall

; 65   : 
; 66   : 	CPUStruc *cpu = (CPUStruc*)kmalloc(sizeof(CPUStruc));
