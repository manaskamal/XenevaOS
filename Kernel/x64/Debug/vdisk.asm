...
$SG3453	DB	'%x', 00H
	ORG $+1
$SG3446	DB	'VDisk partition created startLBA -> %d ', 0aH, 00H
	ORG $+3
$SG3454	DB	0aH, 00H
	ORG $+2
$SG3447	DB	'vDisk partition guid : ', 00H
$SG3448	DB	'0x%x-0x%x-0x%x-0x', 00H
	ORG $+2
$SG3455	DB	0aH, 00H
	ORG $+2
$SG3461	DB	'Vdisk registered name -> %s ', 0aH, 00H
CONST	ENDS
