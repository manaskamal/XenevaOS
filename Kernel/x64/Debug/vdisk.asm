...
$SG3452	DB	'%x', 00H
	ORG $+1
$SG3445	DB	'VDisk partition created startLBA -> %d ', 0aH, 00H
	ORG $+3
$SG3453	DB	0aH, 00H
	ORG $+2
$SG3446	DB	'vDisk partition guid : ', 00H
$SG3447	DB	'0x%x-0x%x-0x%x-0x', 00H
	ORG $+2
$SG3454	DB	0aH, 00H
	ORG $+2
$SG3460	DB	'Vdisk registered name -> %s ', 0aH, 00H
CONST	ENDS
