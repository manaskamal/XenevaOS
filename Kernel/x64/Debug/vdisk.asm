...
$SG3451	DB	'%x', 00H
	ORG $+1
$SG3444	DB	'VDisk partition created startLBA -> %d ', 0aH, 00H
	ORG $+3
$SG3452	DB	0aH, 00H
	ORG $+2
$SG3445	DB	'vDisk partition guid : ', 00H
$SG3446	DB	'0x%x-0x%x-0x%x-0x', 00H
	ORG $+2
$SG3453	DB	0aH, 00H
	ORG $+2
$SG3459	DB	'Vdisk registered name -> %s ', 0aH, 00H
CONST	ENDS
