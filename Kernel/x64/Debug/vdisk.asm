...
$SG3482	DB	'%x', 00H
	ORG $+1
$SG3475	DB	'VDisk partition created startLBA -> %d ', 0aH, 00H
	ORG $+3
$SG3483	DB	0aH, 00H
	ORG $+2
$SG3476	DB	'vDisk partition guid : ', 00H
$SG3477	DB	'0x%x-0x%x-0x%x-0x', 00H
	ORG $+2
$SG3484	DB	0aH, 00H
	ORG $+2
$SG3490	DB	'Vdisk registered name -> %s ', 0aH, 00H
CONST	ENDS
