...
$SG3498	DB	0aH, 00H
	ORG $+2
$SG3499	DB	'VDisk partition created startLBA -> %d ', 0aH, 00H
	ORG $+3
$SG3506	DB	'%x', 00H
	ORG $+1
$SG3500	DB	'vDisk partition guid : ', 00H
$SG3501	DB	'0x%x-0x%x-0x%x-0x', 00H
	ORG $+2
$SG3507	DB	0aH, 00H
	ORG $+2
$SG3508	DB	0aH, 00H
	ORG $+6
$SG3514	DB	'Vdisk registered name -> %s, serial -> %s ', 0aH, 00H
CONST	ENDS
