...
$SG3420	DB	'%x', 00H
	ORG $+1
$SG3413	DB	'VDisk partition created startLBA -> %d ', 0aH, 00H
	ORG $+3
$SG3421	DB	0aH, 00H
	ORG $+2
$SG3414	DB	'vDisk partition guid : ', 00H
$SG3415	DB	'0x%x-0x%x-0x%x-0x', 00H
	ORG $+2
$SG3422	DB	0aH, 00H
	ORG $+2
$SG3428	DB	'Vdisk registered name -> %s ', 0aH, 00H
CONST	ENDS
