...
$SG3437	DB	'%x', 00H
	ORG $+1
$SG3430	DB	'VDisk partition created startLBA -> %d ', 0aH, 00H
	ORG $+3
$SG3438	DB	0aH, 00H
	ORG $+2
$SG3431	DB	'vDisk partition guid : ', 00H
$SG3432	DB	'0x%x-0x%x-0x%x-0x', 00H
	ORG $+2
$SG3439	DB	0aH, 00H
	ORG $+2
$SG3445	DB	'Vdisk registered name -> %s ', 0aH, 00H
CONST	ENDS
