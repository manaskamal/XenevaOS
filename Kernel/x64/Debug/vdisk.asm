...
$SG3418	DB	'%x', 00H
	ORG $+1
$SG3411	DB	'VDisk partition created startLBA -> %d ', 0aH, 00H
	ORG $+3
$SG3419	DB	0aH, 00H
	ORG $+2
$SG3412	DB	'vDisk partition guid : ', 00H
$SG3413	DB	'0x%x-0x%x-0x%x-0x', 00H
	ORG $+2
$SG3420	DB	0aH, 00H
	ORG $+2
$SG3426	DB	'Vdisk registered name -> %s ', 0aH, 00H
CONST	ENDS
