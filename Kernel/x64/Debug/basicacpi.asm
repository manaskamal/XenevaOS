...
_BSS	ENDS
CONST	SEGMENT
$SG8794	DB	'[ACPI]: Data structures incomplete ', 0aH, 00H
	ORG $+3
$SG8797	DB	'[ACPI]: Already enabled ', 0aH, 00H
	ORG $+6
$SG8800	DB	'ACPI Enabled successfully', 0aH, 00H
	ORG $+5
$SG8804	DB	'ACPI Enabled successfully', 0aH, 00H
	ORG $+5
$SG8826	DB	'FADT Handler called ', 0aH, 00H
	ORG $+2
$SG8848	DB	'acpi cpu count -> %d ', 0aH, 00H
	ORG $+1
$SG8852	DB	'acpi ioapic base -> %x, gsi -> %d ', 0aH, 00H
	ORG $+4
$SG8856	DB	'acpi interrupt source override gsi -> %d, src-> %d ', 0aH
	DB	00H
	ORG $+3
$SG8886	DB	'FACP', 00H
	ORG $+3
$SG8887	DB	'FACP', 00H
	ORG $+3
$SG8889	DB	'acpi fadt supported ', 0aH, 00H
	ORG $+2
$SG8892	DB	'CIPA', 00H
	ORG $+3
$SG8893	DB	'APIC', 00H
	ORG $+3
$SG8895	DB	'acpi madt supported ', 0aH, 00H
	ORG $+2
$SG8898	DB	'SRAT', 00H
	ORG $+3
$SG8899	DB	'SRAT', 00H
	ORG $+3
$SG8900	DB	'acpi srat supported ', 0aH, 00H
	ORG $+2
$SG8903	DB	'SLIT', 00H
	ORG $+3
$SG8904	DB	'SLIT', 00H
	ORG $+3
$SG8905	DB	'acpi slit supported ', 0aH, 00H
	ORG $+2
$SG8908	DB	'MCFG', 00H
	ORG $+3
$SG8909	DB	'MCFG', 00H
	ORG $+3
$SG8910	DB	'acpi mcfg supported ', 0aH, 00H
	ORG $+2
$SG8914	DB	'HPET', 00H
	ORG $+3
$SG8915	DB	'HPET', 00H
	ORG $+3
$SG8916	DB	'acpi hpet supported ', 0aH, 00H
	ORG $+2
$SG8919	DB	'MCHI', 00H
	ORG $+3
$SG8920	DB	'MCHI', 00H
	ORG $+3
$SG8921	DB	'acpi management controller host interface supported', 0aH
	DB	00H
	ORG $+3
$SG8989	DB	'Failed to initialise acpi subsystem ', 0aH, 00H
	ORG $+2
$SG8991	DB	'Failed to load acpi tables ', 0aH, 00H
CONST	ENDS
