...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?AuInitialiseACPISubsys@@YAXPEAU_KERNEL_BOOT_INFO_@@@Z DD imagerel $LN12
...
; 276  : 			AuMapPage((uint64_t)AuPmmngrAlloc(), load_addr + static_cast<uint64_t>(j) * 4096, NULL);
