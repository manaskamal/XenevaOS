...
_BSS	ENDS
CONST	SEGMENT
$SG8795	DB	'[ACPI]: Data structures incomplete ', 0aH, 00H
	ORG $+3
$SG8798	DB	'[ACPI]: Already enabled ', 0aH, 00H
	ORG $+6
$SG8801	DB	'ACPI Enabled successfully', 0aH, 00H
	ORG $+5
$SG8805	DB	'ACPI Enabled successfully', 0aH, 00H
	ORG $+5
$SG8827	DB	'FADT Handler called ', 0aH, 00H
	ORG $+2
$SG8849	DB	'acpi cpu count -> %d ', 0aH, 00H
	ORG $+1
$SG8853	DB	'acpi ioapic base -> %x, gsi -> %d ', 0aH, 00H
	ORG $+4
$SG8857	DB	'acpi interrupt source override gsi -> %d, src-> %d ', 0aH
	DB	00H
	ORG $+3
$SG8887	DB	'FACP', 00H
	ORG $+3
$SG8888	DB	'FACP', 00H
	ORG $+3
$SG8890	DB	'acpi fadt supported ', 0aH, 00H
	ORG $+2
$SG8893	DB	'CIPA', 00H
	ORG $+3
$SG8894	DB	'APIC', 00H
	ORG $+3
$SG8896	DB	'acpi madt supported ', 0aH, 00H
	ORG $+2
$SG8899	DB	'SRAT', 00H
	ORG $+3
$SG8900	DB	'SRAT', 00H
	ORG $+3
$SG8901	DB	'acpi srat supported ', 0aH, 00H
	ORG $+2
$SG8904	DB	'SLIT', 00H
	ORG $+3
$SG8905	DB	'SLIT', 00H
	ORG $+3
$SG8906	DB	'acpi slit supported ', 0aH, 00H
	ORG $+2
$SG8909	DB	'MCFG', 00H
	ORG $+3
$SG8910	DB	'MCFG', 00H
	ORG $+3
$SG8911	DB	'acpi mcfg supported ', 0aH, 00H
	ORG $+2
$SG8915	DB	'HPET', 00H
	ORG $+3
$SG8916	DB	'HPET', 00H
	ORG $+3
$SG8917	DB	'acpi hpet supported ', 0aH, 00H
	ORG $+2
$SG8920	DB	'MCHI', 00H
	ORG $+3
$SG8921	DB	'MCHI', 00H
	ORG $+3
$SG8922	DB	'acpi management controller host interface supported', 0aH
	DB	00H
	ORG $+3
$SG8990	DB	'Failed to initialise acpi subsystem ', 0aH, 00H
	ORG $+2
$SG8992	DB	'Failed to load acpi tables ', 0aH, 00H
CONST	ENDS
...
; 179  : 		else if (!strncmp(sig, ACPI_SIG_SRAT, strlen(ACPI_SIG_SRAT))) {
	...
	lea	rcx, OFFSET FLAT:$SG8899
	call	strlen
	mov	r8, rax
	lea	rdx, OFFSET FLAT:$SG8900
	lea	rcx, QWORD PTR sig$[rsp]
	call	strncmp
	test	eax, eax
...
; 184  : 		else if (!strncmp(sig, ACPI_SIG_SLIT, strlen(ACPI_SIG_SLIT))) {
	...
	lea	rcx, OFFSET FLAT:$SG8904
	call	strlen
	mov	r8, rax
	lea	rdx, OFFSET FLAT:$SG8905
	lea	rcx, QWORD PTR sig$[rsp]
	call	strncmp
	test	eax, eax
...
; 187  : 		else if (!strncmp(sig, ACPI_SIG_MCFG, strlen(ACPI_SIG_MCFG))) {
	...
	lea	rcx, OFFSET FLAT:$SG8909
	call	strlen
	mov	r8, rax
	lea	rdx, OFFSET FLAT:$SG8910
	lea	rcx, QWORD PTR sig$[rsp]
	call	strncmp
	test	eax, eax
