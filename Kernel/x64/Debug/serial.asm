...
; 68   : void DebugSerial(char* string) {

$LN6:
	mov	QWORD PTR [rsp+8], rcx
	sub	rsp, 56					; 00000038H

; 69   : 	for (int i = 0; i < strlen(string); i++)
...
; 59   : int is_transmit_empty() {

$LN3:
	sub	rsp, 40					; 00000028H

; 60   : 	return x64_inportb(SERIAL_PORT + 5) & 0x20;
...
; 38   : void SerialInterruptHandler(size_t v, void* p) {
...
; 77   : AU_EXTERN AU_EXPORT void SeTextOut(char* format, ...) {
...
; 91   : 				{
; 92   : 					for (size_t i = 2; format[i] >= '0' && format[i] <= '9'; ++i)
...
; 97   : 				}
; 98   : 				size_t i = va_arg(args, size_t);
...
; 99   : 				char buffer[sizeof(size_t)* 8 + 1];
; 100  : 				//	size_t len
; 101  : 				if (i < 0) {
...
; 116  : 				//char buffer[sizeof(size_t) * 8 + 1];
; 117  : 				//sztoa(c, buffer, 10);
; 118  : 				//puts(buffer);
; 119  : 				WriteSerial(c);
...
; 122  : 			{
; 123  : 				size_t x = va_arg(args, size_t);
...
; 124  : 				char buffer[sizeof(size_t)* 8 + 1];
; 125  : 				sztoa(x, buffer, 16);
...
; 135  : 			{
; 136  : 				double x = va_arg(args, double);
...
; 144  : 			{
; 145  : 				char buf[3];
; 146  : 				buf[0] = '%'; buf[1] = *format; buf[2] = '\0';
...
; 46   : void AuInitialiseSerial() {

$LN3:
	sub	rsp, 40					; 00000028H

; 47   : 	x64_outportb(SERIAL_PORT + 1, 0x00);

	xor	edx, edx
	mov	cx, 1017				; 000003f9H
	call	x64_outportb

; 48   : 	x64_outportb((SERIAL_PORT + 3), 0x80);

	mov	dl, 128					; 00000080H
	mov	cx, 1019				; 000003fbH
	call	x64_outportb

; 49   : 	x64_outportb((SERIAL_PORT + 0), 0x03);

	mov	dl, 3
	mov	cx, 1016				; 000003f8H
	call	x64_outportb

; 50   : 	x64_outportb((SERIAL_PORT + 1), 0x00);

	xor	edx, edx
	mov	cx, 1017				; 000003f9H
	call	x64_outportb

; 51   : 	x64_outportb((SERIAL_PORT + 3), 0x03);

	mov	dl, 3
	mov	cx, 1019				; 000003fbH
	call	x64_outportb

; 52   : 	x64_outportb((SERIAL_PORT + 2), 0xC7);

	mov	dl, 199					; 000000c7H
	mov	cx, 1018				; 000003faH
	call	x64_outportb

; 53   : 	x64_outportb((SERIAL_PORT + 4), 0x0B);
...
; 54   : 
; 55   : 	//x64_outportb (PORT + 4, 0x0F);
; 56   : 	//interrupt_set (4,serial_handler, 4);
; 57   : }
