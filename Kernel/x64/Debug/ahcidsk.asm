...
CONST	SEGMENT
$SG3487	DB	'[AHCI]:Port Hung', 0aH, 00H
	ORG $+6
$SG3493	DB	'[AHCI]: Port error ', 0dH, 0aH, 00H
	ORG $+2
$SG3522	DB	'[AHCI]:Port Hung', 0aH, 00H
	ORG $+6
$SG3557	DB	'ahci Port Supports cold presence %d', 0aH, 00H
CONST	ENDS
