...
_BSS	ENDS
CONST	SEGMENT
$SG4335	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4370	DB	'/', 00H
	ORG $+2
$SG4356	DB	'AuDriverMain', 00H
	ORG $+3
$SG4359	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4365	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4372	DB	'/audrv.cnf', 00H
CONST	ENDS
