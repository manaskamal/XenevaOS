...
_BSS	ENDS
CONST	SEGMENT
$SG4289	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4324	DB	'/', 00H
	ORG $+2
$SG4310	DB	'AuDriverMain', 00H
	ORG $+3
$SG4313	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4319	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4326	DB	'/audrv.cnf', 00H
CONST	ENDS
