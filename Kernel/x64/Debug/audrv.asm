...
_BSS	ENDS
CONST	SEGMENT
$SG4376	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4411	DB	'/', 00H
	ORG $+2
$SG4397	DB	'AuDriverMain', 00H
	ORG $+3
$SG4400	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4406	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4413	DB	'/audrv.cnf', 00H
CONST	ENDS
