...
_BSS	ENDS
CONST	SEGMENT
$SG4415	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4450	DB	'/', 00H
	ORG $+2
$SG4436	DB	'AuDriverMain', 00H
	ORG $+3
$SG4439	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4445	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4452	DB	'/audrv.cnf', 00H
CONST	ENDS
