...
_BSS	ENDS
CONST	SEGMENT
$SG4288	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4323	DB	'/', 00H
	ORG $+2
$SG4309	DB	'AuDriverMain', 00H
	ORG $+3
$SG4312	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4318	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4325	DB	'/audrv.cnf', 00H
CONST	ENDS
