...
_BSS	ENDS
CONST	SEGMENT
$SG4352	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4387	DB	'/', 00H
	ORG $+2
$SG4373	DB	'AuDriverMain', 00H
	ORG $+3
$SG4376	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4382	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4389	DB	'/audrv.cnf', 00H
CONST	ENDS
