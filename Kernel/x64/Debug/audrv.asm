...
_BSS	ENDS
CONST	SEGMENT
$SG4336	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4371	DB	'/', 00H
	ORG $+2
$SG4357	DB	'AuDriverMain', 00H
	ORG $+3
$SG4360	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4366	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4373	DB	'/audrv.cnf', 00H
CONST	ENDS
