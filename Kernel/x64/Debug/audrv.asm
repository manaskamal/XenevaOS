...
_BSS	ENDS
CONST	SEGMENT
$SG4413	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4448	DB	'/', 00H
	ORG $+2
$SG4434	DB	'AuDriverMain', 00H
	ORG $+3
$SG4437	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4443	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4450	DB	'/audrv.cnf', 00H
CONST	ENDS
