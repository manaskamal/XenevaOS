...
_BSS	ENDS
CONST	SEGMENT
$SG4347	DB	'Drivername -> %s ', 0dH, 0aH, 00H
$SG4382	DB	'/', 00H
	ORG $+2
$SG4368	DB	'AuDriverMain', 00H
	ORG $+3
$SG4371	DB	'AuDriverUnload', 00H
	ORG $+1
$SG4377	DB	'[Aurora]: Initializing drivers, please wait... ', 0aH, 00H
	ORG $+7
$SG4384	DB	'/audrv.cnf', 00H
CONST	ENDS
