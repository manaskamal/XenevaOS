...
PUBLIC	?null_call@@YA_K_J00000@Z			; null_call
...
EXTRN	?AuGetVDiskInfo@@YAHEPEAX@Z:PROC		; AuGetVDiskInfo
EXTRN	?AuGetVDiskPartitionInfo@@YAHEEPEAX@Z:PROC	; AuGetVDiskPartitionInfo
msvcjmc	SEGMENT
__A02DB339_x86_64_systable@cpp DB 01H
msvcjmc	ENDS
PUBLIC	?KePrintMsg@@YA_K_J00000@Z			; KePrintMsg
...
;	COMDAT pdata
pdata	SEGMENT
$pdata$?KePrintMsg@@YA_K_J00000@Z DD imagerel $LN3
	DD	imagerel $LN3+74
	DD	imagerel $unwind$?KePrintMsg@@YA_K_J00000@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
$pdata$?null_call@@YA_K_J00000@Z DD imagerel $LN3
	DD	imagerel $LN3+50
	DD	imagerel $unwind$?null_call@@YA_K_J00000@Z
pdata	ENDS
;	COMDAT pdata
pdata	SEGMENT
...
pdata	ENDS
_DATA	SEGMENT
?syscalls@@3PAPEAXA DQ FLAT:?null_call@@YA_K_J00000@Z	; syscalls
	DQ	FLAT:SeTextOut
	...
	DQ	FLAT:?AuGetVDiskInfo@@YAHEPEAX@Z
	DQ	FLAT:?AuGetVDiskPartitionInfo@@YAHEEPEAX@Z
_DATA	ENDS
...
;	COMDAT xdata
xdata	SEGMENT
$unwind$?null_call@@YA_K_J00000@Z DD 025031e01H
	DD	0b219231eH
	DD	05015H
xdata	ENDS
;	COMDAT xdata
xdata	SEGMENT
$unwind$?KePrintMsg@@YA_K_J00000@Z DD 025031e01H
	DD	0d219231eH
	DD	05015H
xdata	ENDS
...
; 139  : extern "C" int64_t x64_syscall_handler(int a) {
...
; 141  : 	AuThread* current_thr = AuGetCurrentThread();

	call	AuGetCurrentThread
	mov	QWORD PTR current_thr$[rbp], rax

; 142  : 	uint64_t ret_code = 0;

	mov	QWORD PTR ret_code$[rbp], 0

; 143  : 
; 144  : 	if (a < 0 || a >= AURORA_MAX_SYSCALL)

	cmp	DWORD PTR a$[rbp], 0
	jl	SHORT $LN3@x64_syscal
	cmp	DWORD PTR a$[rbp], 57			; 00000039H
...
; 146  : 	
; 147  : 	syscall_func func = (syscall_func)syscalls[a];
...
; 150  : 
; 151  : 	ret_code = func(current_thr->syscall_param.param1, current_thr->syscall_param.param2, current_thr->syscall_param.param3,
...
; 152  : 			current_thr->syscall_param.param4, current_thr->syscall_param.param5, current_thr->syscall_param.param6);
; 153  : 
; 154  : 	return ret_code;
...
; Function compile flags: /Odtp /ZI
; File E:\Xeneva Project\Aurora\Kernel\Hal\x86_64_systable.cpp
;	COMDAT ?null_call@@YA_K_J00000@Z
_TEXT	SEGMENT
param1$ = 80
param2$ = 88
param3$ = 96
...
param5$ = 112
param6$ = 120
?null_call@@YA_K_J00000@Z PROC				; null_call, COMDAT

; 69   : 	param4, int64_t param5, int64_t param6) {
...
; 71   : }
	...
	pop	rbp
	ret	0
?null_call@@YA_K_J00000@Z ENDP				; null_call
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File E:\Xeneva Project\Aurora\Kernel\Hal\x86_64_systable.cpp
;	COMDAT ?KePrintMsg@@YA_K_J00000@Z
_TEXT	SEGMENT
text$ = 0
param1$ = 96
param2$ = 104
...
param5$ = 128
param6$ = 136
?KePrintMsg@@YA_K_J00000@Z PROC				; KePrintMsg, COMDAT

; 59   : 	param4, int64_t param5, int64_t param6) {
...
; 63   : }
	...
	pop	rbp
	ret	0
?KePrintMsg@@YA_K_J00000@Z ENDP				; KePrintMsg
_TEXT	ENDS
END
