...
; 125  : extern "C" uint64_t x64_syscall_handler(int a) {
...
; 128  : 	uint64_t ret_code = 0;

	mov	QWORD PTR ret_code$[rsp], 0

; 129  : 
; 130  : 	if (a > AURORA_MAX_SYSCALL)

	cmp	DWORD PTR a$[rsp], 45			; 0000002dH
...
; 132  : 	
; 133  : 	syscall_func func = (syscall_func)syscalls[a];
...
; 136  : 
; 137  : 	ret_code = func(current_thr->syscall_param.param1, current_thr->syscall_param.param2, current_thr->syscall_param.param3,
; 138  : 			current_thr->syscall_param.param4, current_thr->syscall_param.param5, current_thr->syscall_param.param6);
