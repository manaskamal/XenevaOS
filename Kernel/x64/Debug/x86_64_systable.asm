...
; 140  : 	if (a > AURORA_MAX_SYSCALL)
	...
	cmp	DWORD PTR a$[rbp], 54			; 00000036H
...
; 68   : 	param4, uint64_t param5, uint64_t param6) {
...
; 58   : 	param4, uint64_t param5, uint64_t param6) {
