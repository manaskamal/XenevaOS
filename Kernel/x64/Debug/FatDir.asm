...
CONST	SEGMENT
$SG3588	DB	'Ret filename ->%s ', 0dH, 0aH, 00H
	ORG $+3
$SG3590	DB	'FS Flag dir ', 0dH, 0aH, 00H
	ORG $+1
$SG3592	DB	'freeing ret ', 0dH, 0aH, 00H
	ORG $+1
$SG3597	DB	'/', 00H
CONST	ENDS
