...
$SG3847	DB	'exe', 00H
	ORG $+4
$SG3848	DB	'[aurora]: non-executable process ', 0dH, 0aH, 00H
	ORG $+4
$SG3887	DB	'/xeldr.exe', 00H
	ORG $+5
$SG3922	DB	'Arguments address already mapped ', 0aH, 00H
CONST	ENDS
...
; 242  : 	AuReleaseSpinlock(loader_lock);
