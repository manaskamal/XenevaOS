...
$SG3941	DB	'exe', 00H
	ORG $+4
$SG3942	DB	'[aurora]: non-executable process ', 0dH, 0aH, 00H
	ORG $+4
$SG3946	DB	'No File found -> %s ', 0dH, 0aH, 00H
	ORG $+1
$SG3997	DB	'/xeldr.exe', 00H
	ORG $+5
$SG4032	DB	'Arguments address already mapped ', 0aH, 00H
CONST	ENDS
