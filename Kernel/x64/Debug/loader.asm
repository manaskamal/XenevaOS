...
$SG3837	DB	'exe', 00H
	ORG $+4
$SG3838	DB	'[aurora]: non-executable process ', 0dH, 0aH, 00H
	ORG $+4
$SG3877	DB	'/xeldr.exe', 00H
	ORG $+5
$SG3912	DB	'Arguments address already mapped ', 0aH, 00H
CONST	ENDS
