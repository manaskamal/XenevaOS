...
PUBLIC	??_C@_0M@NPOAOGCF@Jul?5?51?52024@		; `string'
PUBLIC	?_kernel_build_time@@3PEBDEB			; _kernel_build_time
PUBLIC	??_C@_08FJLGNDIC@10?317?347@			; `string'
_BSS	SEGMENT
?_kernel_minor_version@@3HA DD 01H DUP (?)		; _kernel_minor_version
?_kernel_patch_version@@3HA DD 01H DUP (?)		; _kernel_patch_version
_BSS	ENDS
;	COMDAT ??_C@_08FJLGNDIC@10?317?347@
CONST	SEGMENT
??_C@_08FJLGNDIC@10?317?347@ DB '10:17:47', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0M@NPOAOGCF@Jul?5?51?52024@
CONST	SEGMENT
??_C@_0M@NPOAOGCF@Jul?5?51?52024@ DB 'Jul  1 2024', 00H	; `string'
CONST	ENDS
...
?_kernel_major_version@@3HA DD 01H			; _kernel_major_version
	ORG $+4
?_kernel_build_date@@3PEBDEB DQ FLAT:??_C@_0M@NPOAOGCF@Jul?5?51?52024@ ; _kernel_build_date
?_kernel_build_time@@3PEBDEB DQ FLAT:??_C@_08FJLGNDIC@10?317?347@ ; _kernel_build_time
_DATA	ENDS
END
