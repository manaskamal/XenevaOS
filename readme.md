...
## Documentation
Refer to [Documentations of XenevaOS](Docs/Introduction.md)<br>
Refer to [API Documentations of XenevaOS](https://bytejoseph.github.io/xeneva-source-reference/files.html). _Thanks to ByteJoseph for API docs_.
